...
const YesIntentHandler = {
  ...
  async handle(handlerInput) {
    ...
    Utils.log('info', 'AMAZON.YesIntent received - session attributes:', sessionAttributes);
    Utils.log('info', 'AMAZON.YesIntent - alertsOffered flag:', sessionAttributes.alertsOffered);
    Utils.log('info', 'AMAZON.YesIntent - promptedForNextDay flag:', sessionAttributes.promptedForNextDay);
...
const NoIntentHandler = {
  canHandle(handlerInput) {
    ...
    if (result) Utils.log('info', 'NoIntentHandler.canHandle = true for AMAZON.NoIntent');
    return result;
  },
  handle(handlerInput) {
    Utils.log('info', 'AMAZON.NoIntent received - user declined prompt');
    
    return handlerInput.responseBuilder
      .speak('Okay. You can ask me about ferry times anytime.')
      .getResponse();
  }
};
...
const HelpIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    Say "Alexa, ask Red Hook Ferry Checker when is the next boat" to get upcoming departures.
    Say "Alexa, ask Red Hook Ferry Checker for ferries after 3 PM" to get departures after a specific time.
    Say "Alexa, ask Red Hook Ferry Checker are there any service alerts" to check for delays.
...
const ErrorHandler = {
  ...
  handle(handlerInput, error) {
    ...
    return handlerInput.responseBuilder
      .speak(speakOutput)
      .reprompt('You can ask me about the next ferries by saying, Alexa, ask Red Hook Ferry Checker when is the next boat.')
      .getResponse();
  }
};
